...
export declare function getDefaultTargetAsync(projectDir: string): Promise<ProjectTarget>;
export declare function isBareWorkflowProjectAsync(projectDir: string): Promise<boolean>;
