...
function generateSplashAsync({ projectRoot, publicPath }, icon) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const data = yield Promise.all(icons.map((icon) => __awaiter(this, void 0, void 0, function* () {
            const { source, name } = yield Image.generateImageAsync({ projectRoot, cacheType }, icon);
...
function generateAppleIconAsync({ projectRoot, publicPath }, icon, { sizes = [180] }) {
    return __awaiter(this, void 0, void 0, function* () {
        const cacheType = 'apple-touch-icon';
        const data = yield Promise.all(sizes.map((size) => __awaiter(this, void 0, void 0, function* () {
            const rel = 'apple-touch-icon';
            const { source, name } = yield Image.generateImageAsync({ projectRoot, cacheType }, Object.assign(Object.assign({}, icon), { width: size, height: size, name: `${rel}-${size}.png` }));
...
function generateChromeIconAsync({ projectRoot, publicPath }, icon, { sizes = [144, 192, 512] }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function generateFaviconAsync({ projectRoot, publicPath }, icon) {
    return __awaiter(this, void 0, void 0, function* () {
        const cacheType = 'favicon';
        const dimensions = [16, 32, 48];
        const data = yield Promise.all(dimensions.map((size) => __awaiter(this, void 0, void 0, function* () {
            const rel = 'icon';
            const { source, name } = yield Image.generateImageAsync({ projectRoot, cacheType }, Object.assign(Object.assign({ backgroundColor: 'transparent' }, icon), { width: size, height: size, name: `favicon-${size}.png` }));
            const href = `${name}`;
            return {
                asset: {
                    source,
        ...
        const faviconBuffer = yield Image.generateFaviconAsync(largestImageBuffer, dimensions);
        yield Image.Cache.clearUnusedCachesAsync(projectRoot, cacheType);
        return [
            data[0],
            data[1],
